...
<div id="wd-css-navigating-with-tabs">
  ...
  <ul className="nav nav-tabs">
    <li className="nav-item">
        <a className="nav-link active" href="#wd-lab1">Active</a>
    </li>
    <li className="nav-item">
        <a className="nav-link" href="#wd-lab2">Link</a>
    </li>
    <li className="nav-item">
        <a className="nav-link" href="#wd-lab3">Link</a>
    </li>
    <li className="nav-item">
        <a className="nav-link disabled" href="#wd-lab1">Disabled</a>
    </li>
  </ul>
</div>
...
<div id="wd-css-navigating-with-cards">
  ...
  <div className="card"
    ...
    <div className="card-body">
      ...
      <a href="#wd-lab2" className="btn btn-primary">
        Boldly Go
      </a>
    </div>
  </div>
